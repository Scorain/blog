...
![点击此图获取全部CSS Grid课程](/blog/images/recreate-medium-article-layout-with-grid/1.png)
...
![](/blog/images/recreate-medium-article-layout-with-grid/2.png)
...
![](/blog/images/recreate-medium-article-layout-with-grid/3.png)
...
![](/blog/images/recreate-medium-article-layout-with-grid/4.jpg)
...
![](/blog/images/recreate-medium-article-layout-with-grid/5.png)
...
![提示：在移动端，此类图片和全屏宽图片表现一致。本文中，我们只关注桌面端布局](/blog/images/recreate-medium-article-layout-with-grid/6.jpg)
...
![](/blog/images/recreate-medium-article-layout-with-grid/7.png)
...
![](/blog/images/recreate-medium-article-layout-with-grid/8.png)
...
![](/blog/images/recreate-medium-article-layout-with-grid/9.png)

### 侧面标记

现在还有最后一种类型需要支持。Medium上有一个非常好的标明文章中突出内容的方式。文本变绿，并在右上角产生一个高亮标记。

![](/blog/images/recreate-medium-article-layout-with-grid/10.png)
...
![](/blog/images/recreate-medium-article-layout-with-grid/11.png)
